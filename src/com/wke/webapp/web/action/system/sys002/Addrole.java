...
@Results({ @Result(name = "success", location = "/WEB-INF/comm/goto.ftl"),
		@Result(name = "input", location = "/WEB-INF/system/sys002/addRole.ftl") })
public class Addrole extends BaseAction {

	@Override
	@Validations(requiredStrings = {
			@RequiredStringValidator(fieldName = "role.jsmc", type = ValidatorType.FIELD, message = "请输入角色名称", shortCircuit = true),
			@RequiredStringValidator(fieldName = "role.jsms", type = ValidatorType.FIELD, message = "请输入角色描述", shortCircuit = true),
	...
	public String execute() {
		...
		if (getRoleService().addRole(role)) {
